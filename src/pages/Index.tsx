...
const Index = () => {
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <section className="bg-black relative h-screen flex items-center overflow-hidden">
        {/* Background elements */}
        <div className="absolute inset-0 z-0">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-900/70 via-black to-black"></div>
          ...
          <div className="absolute w-[300px] h-[300px] left-[20%] top-[30%] rounded-full bg-white/5 blur-[80px] opacity-20"></div>
            ...
            <div className="premium-glass p-6 rounded-xl border border-white/10 shadow-2xl">
              ...
              <div className="h-64 overflow-hidden text-left p-4 space-y-4">
                ...
                >
                  ...
                  <span className="text-gray-300"> Core initialized</span>
                </motion.div>
                <motion.div 
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                >
                  <span className="text-white">✓</span>
                  <span className="text-gray-300"> Module [science] loaded</span>
                </motion.div>
                <motion.div 
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                >
                  <span className="text-white">✓</span>
                  <span className="text-gray-300"> Verification layer active [1000/1000]</span>
                </motion.div>
                <motion.div 
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                >
                  <span className="text-white">$</span>
                  <span className="text-white ml-2">LocalHouseLLM ready. Ask your question.</span>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: [0, 1, 0] }}
                  transition={{ delay: 3.5, duration: 0.8, repeat: Infinity, repeatDelay: 0.5 }}
                >
