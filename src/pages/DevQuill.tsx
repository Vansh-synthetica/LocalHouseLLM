...
import { Code2, RefreshCw, Bug, ArrowRight, Sparkles } from 'lucide-react';
...
const features = [
  {
    ...
    description: 'Generate production-ready code with context-aware intelligence.',
  },
  {
    icon: RefreshCw,
    title: 'Context-Aware Refactoring',
    description: 'Refactor entire codebases while preserving intent and structure.',
  },
  {
    icon: Bug,
    title: 'Debug & Optimize Faster',
    description: 'Identify bottlenecks and fix issues before they reach production.',
  },
];
...
const DevQuill = () => {
  ...
  return (
    <Layout>
      <SEO
        title="DevQuill — AI-Powered Coding Assistant | LocalHouseLLM"
        description="DevQuill is a precision AI coding assistant. Write, refactor, and ship faster with intelligent code generation."
        keywords="DevQuill, AI coding assistant, code generation, refactoring, LocalHouseLLM"
      />
      ...
      <section className="min-h-[80vh] flex items-center justify-center px-4">
        <div className="max-container text-center">
          ...
          >
            Precision AI for Developers. Write, refactor, and ship faster.
          </motion.p>
          ...
          >
            An intelligent coding assistant designed to help developers write clean, efficient, production-ready code.
          </motion.p>
        ...
        <div className="max-container">
          ...
          >
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              Built by <span className="text-foreground font-medium">LocalHouseLLM</span>. DevQuill is the first step toward a new generation of modular AI systems — designed to augment developers, not replace them.
            </p>
          </motion.div>
        </div>
      </section>
