...
import { CapabilityVisual } from '@/components/system/StackVisuals';
      ...
      <div className="max-container max-w-3xl">
        ...
        <Reveal>
          <p className="text-muted-foreground leading-relaxed mb-10">
            Every tool ships with a typed schema, a permission scope, and a verification hook. Calls and responses
            flow through <Link to="/stack/aicl" className="text-foreground underline underline-offset-4">AICL</Link>,
            so tool use is loggable and auditable end-to-end.
          </p>

          <h2 className="font-display text-2xl md:text-3xl font-semibold mb-5">Built-in categories</h2>
