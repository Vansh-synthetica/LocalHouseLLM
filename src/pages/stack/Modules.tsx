...
import { SpecializationVisual } from '@/components/system/StackVisuals';
      ...
      <div className="max-container max-w-3xl">
        <Reveal>
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-6">
            An intelligence module is a single, focused expert: a model (or a small system of models) responsible
            for one well-scoped capability. A medical reasoner. A code synthesizer. A retrieval-augmented
            summariser. A planner.
          </p>
        </Reveal>
        ...
        <Reveal>
          <p className="text-muted-foreground leading-relaxed mb-10">
            ...
            swap one implementation for another without rewriting the system around it. A small local model today,
            a fine-tuned domain expert tomorrow.
          </p>

          <h2 className="font-display text-2xl md:text-3xl font-semibold mb-5">Why specialization wins</h2>
